...
mod tests {
    ...
    fn setup() {
        ...
        log(&format!("Using API_KEY: {}", api_key));
    }
    ...
    fn test_blend_white_black() {
        ...
        log("Blended white and black successfully");
    }
    ...
    fn test_blend_red_blue() {
        ...
        log("Blended red and blue successfully");
    }
    ...
    fn test_convert_rgb_to_hsl() {
        ...
        log("Converted RGB to HSL successfully");
    }
    ...
    fn test_convert_hsl_to_rgb() {
        ...
        log("Converted HSL to RGB successfully");
    }
}